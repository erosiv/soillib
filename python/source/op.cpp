...
module.def("sparseacc", [](const soil::kdtree& kdtree, const soil::buffer& points, const soil::index& index, const size_t niter){
  return soil::sparseacc(kdtree, points, index, niter);
});
